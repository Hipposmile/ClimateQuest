    ...
    var t = {
        362: (t, e, i) => {
            ...
            function a(t, e, i) {
                ...
                const c = a.x + a.width / 2 - l.width / 2, d = a.y + a.height / 2 - l.height / 2, u = r(e), f = s(u),
                    p = a[f] / 2 - l[f] / 2, h = "x" === u;
                let g;
                switch (n(e)) {
                    case"top":
            ...
            async function d(t, e) {
                ...
                const {
                        ...
                        altBoundary: h = !1,
                        padding: g = 0
                    } = e, m = l(g), v = a[h ? "floating" === p ? "reference" : "floating" : p],
                    y = c(await r.getClippingRect({
            ...
            const h = t => ({
                name: "arrow", options: t, async fn(e) {
                    ...
                    if (null == i) return {};
                    const h = l(n), g = {x: a, y: c}, m = r(d), v = o(d), y = s(m), b = await f.getDimensions(i),
                        w = "y" === m ? "top" : "left", x = "y" === m ? "bottom" : "right",
                        k = u.reference[y] + u.reference[m] - g[m] - u.floating[y], E = g[m] - u.reference[m],
                        _ = await (null == f.getOffsetParent ? void 0 : f.getOffsetParent(i));
                    let S = _ ? "y" === m ? _.clientHeight || 0 : _.clientWidth || 0 : 0;
                    0 === S && (S = u.floating[y]);
                    const P = k / 2 - E / 2, L = h[w], C = S - b[y] - h[x], O = S / 2 - b[y] / 2 + P, B = p(L, O, C),
            ...
            const w = ["top", "right", "bottom", "left"],
                x = w.reduce(((t, e) => t.concat(e, e + "-start", e + "-end")), []), k = function (t) {
                    return void 0 === t && (t = {}), {
                        name: "autoPlacement", options: t, async fn(e) {
                            var i, r, s, a, l;
                            const {
                                    x: c,
                                    y: u,
                                    ...
                                    platform: g,
                                    elements: m
                                } = e, {alignment: y = null, allowedPlacements: w = x, autoAlignment: k = !0, ...E} = t,
                                _ = function (t, e, i) {
                                    return (t ? [...i.filter((e => o(e) === t)), ...i.filter((e => o(e) !== t))] : i.filter((t => n(t) === t))).filter((i => !t || o(i) === t || !!e && b(i) !== i))
                                }(y, k, w), S = await d(e, E),
                                P = null != (i = null == (r = p.autoPlacement) ? void 0 : r.index) ? i : 0, L = _[P];
                            if (null == L) return {};
                            ...
                            const D = A.slice().sort(((t, e) => t.overflows[0] - e.overflows[0])),
                                ...
                                }))) ? void 0 : l.placement, M = null != R ? R : D[0].placement;
                    ...
                    return void 0 === t && (t = {}), {
                        name: "flip", options: t, async fn(e) {
                            ...
                            if (S = [...S, {placement: o, overflows: _}], !_.every((t => t <= 0))) {
                                var P, L;
                                const t = (null != (P = null == (L = r.flip) ? void 0 : L.index) ? P : 0) + 1, e = k[t];
            ...
            const P = function (t) {
                ...
                return void 0 === t && (t = 0), {
                    name: "offset", options: t, async fn(e) {
                        const {x: i, y: s} = e, a = await async function (t, e) {
                            const {placement: i, platform: s, elements: a} = t,
                                l = await (null == s.isRTL ? void 0 : s.isRTL(a.floating)), c = n(i), d = o(i),
                                u = "x" === r(i), f = ["left", "top"].includes(c) ? -1 : 1, p = l && u ? -1 : 1,
                                h = "function" == typeof e ? e(t) : e;
                            let {mainAxis: g, crossAxis: m, alignmentAxis: v} = "number" == typeof h ? {
                                mainAxis: h,
                                crossAxis: 0,
                                alignmentAxis: null
            ...
            const O = function (t) {
                return void 0 === t && (t = {}), {
                    name: "shift", options: t, async fn(e) {
                        const {x: i, y: o, placement: s} = e, {
                            ...
                            ...u
                        } = t, f = {x: i, y: o}, h = await d(e, u), g = r(n(s)), m = C(g);
                        let v = f[g], y = f[m];
                        if (a) {
                ...
                return void 0 === t && (t = {}), {
                    name: "size", options: t, async fn(e) {
                        ...
                        const v = f(u.left, 0), y = f(u.right, 0), b = f(u.top, 0), w = f(u.bottom, 0), x = {
                ...
                return void 0 === t && (t = {}), {
                    name: "inline", options: t, async fn(e) {
                        var i;
                        const {placement: o, elements: s, rects: a, platform: d, strategy: p} = e, {
                            ...
                            v = c(d.convertOffsetParentRelativeRectToViewportRelativeRect ? await d.convertOffsetParentRelativeRectToViewportRelativeRect({
                                rect: a.reference,
                            ...
                            b = l(h), w = await d.getElementRects({
                                reference: {
                                    getBoundingClientRect: function () {
                                        ...
                                        if (y.length >= 2) {
                                            if ("x" === r(o)) {
                                                const t = y[0], e = y[y.length - 1], i = "top" === n(o), r = t.top,
                                                    s = e.bottom, a = i ? t.left : e.left, l = i ? t.right : e.right;
                                                return {
                                                    top: r,
                                                    bottom: s,
                                                    left: a,
                                            ...
                                            const t = "left" === n(o), e = f(...y.map((t => t.right))),
                                                i = u(...y.map((t => t.left))),
                                                s = y.filter((n => t ? n.left === i : n.right === e)), a = s[0].top,
                                ...
                                }, floating: s.floating, strategy: p
                            });
            ...
            function N(t) {
                const e = /firefox/i.test(z()), i = M(t);
            ...
            const $ = Math.min, Y = Math.max, X = Math.round;
            ...
            function Z(t, e, i) {
                ...
                let l = 1, c = 1;
                e && j(t) && (l = t.offsetWidth > 0 && X(a.width) / t.offsetWidth || 1, c = t.offsetHeight > 0 && X(a.height) / t.offsetHeight || 1);
                const d = W(t) ? R(t) : window, u = !G() && i,
            ...
            function U(t) {
                return W(t) ? {scrollLeft: t.scrollLeft, scrollTop: t.scrollTop} : {
            ...
            function Q(t, e, i) {
                const n = j(e), o = J(e), r = Z(t, n && function (t) {
                    const e = Z(t);
                    return X(e.width) !== t.offsetWidth || X(e.height) !== t.offsetHeight
                }(e), "fixed" === i);
                let s = {scrollLeft: 0, scrollTop: 0};
                const a = {x: 0, y: 0};
                if (n || !n && "fixed" !== i) if (("body" !== H(e) || I(o)) && (s = U(e)), j(e)) {
                    const t = Z(e, !0);
            ...
            function rt(t, e) {
                var i;
                void 0 === e && (e = []);
                const n = ot(t), o = n === (null == (i = t.ownerDocument) ? void 0 : i.body), r = R(n),
                    s = o ? [r].concat(r.visualViewport || [], I(n) ? n : []) : n, a = e.concat(s);
                return o ? a : a.concat(rt(s))
            }

            function st(t, e, i) {
                return "viewport" === e ? c(function (t, e) {
                    const i = R(t), n = J(t), o = i.visualViewport;
                    ...
                    const i = Z(t, !1, "fixed" === e), n = i.top + t.clientTop, o = i.left + t.clientLeft;
                    return {
                        top: n,
                        left: o,
                        x: o,
                    ...
                    var e;
                    const i = J(t), n = U(t), o = null == (e = t.ownerDocument) ? void 0 : e.body,
                        r = Y(i.scrollWidth, i.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0),
                        s = Y(i.scrollHeight, i.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0);
                    let a = -n.scrollLeft + K(t);
                    const l = -n.scrollTop;
                    return "rtl" === M(o || i).direction && (a += Y(i.clientWidth, o ? o.clientWidth : 0) - r), {
                        width: r,
                        height: s,
                        x: a,
                        y: l
            ...
            const lt = {
                getClippingRect: function (t) {
                    ...
                    const r = [..."clippingAncestors" === i ? at(e) : [].concat(i), n], s = r[0],
                        a = r.reduce(((t, i) => {
                            const n = st(e, i, o);
                            return t.top = Y(n.top, t.top), t.right = $(n.right, t.right), t.bottom = $(n.bottom, t.bottom), t.left = Y(n.left, t.left), t
                        }), st(e, s, o));
                    ...
                    let s = {scrollLeft: 0, scrollTop: 0};
                    const a = {x: 0, y: 0};
                    if ((o || !o && "fixed" !== n) && (("body" !== H(i) || I(r)) && (s = U(i)), j(i))) {
                        const t = Z(i, !0);
                        a.x = t.x + i.clientLeft, a.y = t.y + i.clientTop
                    }
                    return {...e, x: e.x - s.scrollLeft + a.x, y: e.y - s.scrollTop + a.y}
                }, isElement: W, getDimensions: nt, getOffsetParent: it, getDocumentElement: J, getElementRects: t => {
                    let {reference: e, floating: i, strategy: n} = t;
                    return {reference: Q(e, it(i), n), floating: {...nt(i), x: 0, y: 0}}
                }, getClientRects: t => Array.from(t.getClientRects()), isRTL: t => "rtl" === M(t).direction
            };
            ...
            const dt = (t, e, i) => (async (t, e, i) => {
                ...
                let c = await s.getElementRects({reference: t, floating: e, strategy: o}), {x: d, y: u} = a(c, n, l),
                    f = n, p = {}, h = 0;
                for (let i = 0; i < r.length; i++) {
                    const {name: g, fn: m} = r[i], {x: v, y, data: b, reset: w} = await m({
                        x: d,
                        y: u,
                        initialPlacement: n,
                        placement: f,
            ...
            const a = i(693), l = s(i(121)), c = i(319), d = i(166), u = i(737), f = r(i(483)), p = s(i(971)),
                h = s(i(330)), g = s(i(340)), m = s(i(544)), v = r(i(612)), y = r(i(283)), b = s(i(717));
            e.TourGuideClient = class {
                constructor(t) {
                    this.group = "", this.isVisible = !1, this.activeStep = 0, this.tourSteps = [], this.options = b.default, this.isFinished = y.getIsFinished, this._promiseWaiting = !1, this.createTourGuideBackdrop = c.createTourGuideBackdrop, this.computeBackdropAttributes = c.computeBackdropAttributes, this.createTourGuideDialog = a.createTourGuideDialog, this.start = h.default, this.visitStep = f.default, this.addSteps = p.default, this.nextStep = f.handleVisitNextStep, this.prevStep = f.handleVisitPrevStep, this.exit = m.default, this.refresh = v.default, this.refreshDialog = v.handleRefreshDialog, this.finishTour = y.default, this.updatePositions = l.default, this.deleteFinishedTour = y.delFinishedTour, this.setOptions = g.default, this.initListeners = u.handleInitListeners, this.destroyListeners = u.handleDestroyListeners, this._trackedEvents = {
                        ...
                        resizeEvent: {
                            initialized: !1, fn: async function () {
                                await (0, c.computeBackdropPosition)(this), await (0, a.computeDialogPosition)(this)
                            }.bind(this)
                        },
                        scrollEvent: {
                            initialized: !1, fn: async function () {
            ...
            Object.defineProperty(e, "__esModule", {value: !0}), e.computeBackdropPosition = e.computeBackdropAttributes = e.createTourGuideBackdrop = void 0, e.createTourGuideBackdrop = function () {
                ...
                return new Promise((async (e, i) => {
                    ...
                    const n = t.tourSteps[t.activeStep], o = n.target, r = o.getBoundingClientRect(),
                    ...
                    t.backdrop.style.pointerEvents = n.propagateEvents ? "none" : "", t.backdrop.style.width = (s ? r.width : r.width + t.options.targetPadding) + "px", t.backdrop.style.height = (r.height ? r.height + t.options.targetPadding : r.height) + "px", e(!0)
                }))
            }
        }, 166: (t, e) => {
            Object.defineProperty(e, "__esModule", {value: !0}), e.handleOnAfterStepChange = e.handleOnBeforeStepChange = e.handleOnAfterExit = e.handleOnBeforeExit = e.handleOnFinish = void 0, e.handleOnFinish = function (t) {
            ...
            e.createTourGuideDialog = async function () {
                ...
                return new Promise((async e => {
                    ...
                    let n = t.tourSteps[t.activeStep].dialogTarget || t.tourSteps[t.activeStep].target;
                    ...
                    t.dialog.style.position = "absolute", t.dialog.classList.remove("tg-dialog-fixed"), i && (i.style.display = "inline-block"), (0, o.computePosition)(n, t.dialog, {
                        ...
                        middleware: [(0, o.autoPlacement)({
                            ...
                            padding: 15
                        }), (0, o.arrow)({element: i}), (0, o.offset)(20)]
                    }).then((({
                                  x: n,
                                  y: o,
                                  placement: r,
                        ...
                        left: `${n}px`,
                        top: `${o}px`
                    }), s.arrow && i && Object.assign(i.style, function (t, e, i) {
                        const n = t?.x || 0, o = t?.y || 0, r = 10,
                            s = {top: "bottom", right: "left", bottom: "top", left: "right"}[e.split("-")[0]],
                            a = i.clientWidth - r, l = i.clientHeight - r, c = Math.abs(o - l) <= r,
                            d = Math.abs(n - a) <= r, u = Math.abs(o) <= r, f = Math.abs(n) <= r,
                            p = 0 !== t?.centerOffset || (f || d) && (u || c);
                        return {
                            left: f ? "right" === s ? "" : "0" : d ? `${a}px` : `${n}px`,
                            top: u ? "bottom" === s ? "" : "0" : c ? `${l}px` : `${o}px`,
                            [s]: p ? "0" : "-5px",
                            transform: p ? "none" : "rotate(45deg)"
                        }
                    }(s.arrow, r, t.dialog)), e(!0))))
                }))
            }
        }, 500: (t, e) => {
            Object.defineProperty(e, "__esModule", {value: !0}), e.computeDots = e.dotsWrapperHtmlString = void 0, e.dotsWrapperHtmlString = function () {
            ...
            Object.defineProperty(e, "__esModule", {value: !0}), e.keyPressHandler = e.clickOutsideHandler = e.handleDestroyListeners = e.handleInitListeners = void 0, e.clickOutsideHandler = async function (t) {
                ...
                t.clientX >= i.x && t.clientX <= i.x + i.width && t.clientY >= i.y && t.clientY <= i.y + i.height || this.dialog.contains(t.target) || (t.preventDefault(), t.stopPropagation(), t.stopImmediatePropagation(), await this.exit())
                ...
                const t = () => {
                    ...
                    this._trackedEvents.resizeEvent.initialized || (window.addEventListener("resize", this._trackedEvents.resizeEvent.fn, !1), this._trackedEvents.resizeEvent.initialized = !0)
                }, s = () => {
                    this._trackedEvents.scrollEvent.initialized || (window.addEventListener("scroll", this._trackedEvents.scrollEvent.fn, !1), this._trackedEvents.scrollEvent.initialized = !0)
                };
                return new Promise((a => (this.options.showButtons && t(), this.options.showButtons && e(), this.options.closeButton && i(), this.options.exitOnClickOutside && n(), (this.options.keyboardControls || this.options.exitOnEscape) && o(), r(), s(), a(!0))))
                ...
                const t = () => {
                    ...
                    window.removeEventListener("resize", this._trackedEvents.resizeEvent.fn, !1), this._trackedEvents.resizeEvent.initialized = !1
                }, s = () => {
                    window.removeEventListener("scroll", this._trackedEvents.scrollEvent.fn, !1), this._trackedEvents.scrollEvent.initialized = !1
                };
                return new Promise((a => (this.options.showButtons && t(), this.options.showButtons && e(), this.options.closeButton && i(), this.options.exitOnClickOutside && n(), (this.options.keyboardControls || this.options.exitOnEscape) && o(), r(), s(), a(!0))))
            }
        }, 121: (t, e, i) => {
            Object.defineProperty(e, "__esModule", {value: !0});
            const n = i(319), o = i(693);
            e.default = function () {
                return new Promise((async t => {
                    ...
                    }), 300), this.isVisible = !0, setTimeout((() => t(!0)), 300)
                }))
            }
        }, 830: (t, e) => {
            Object.defineProperty(e, "__esModule", {value: !0}), e.default = (t, e) => {
                e.scrollIntoView({
            ...
            Object.defineProperty(e, "__esModule", {value: !0}), e.default = async function (t) {
                return new Promise((async (e, i) => {
                    let n = [];
                    t.options.steps && t.options.steps.length && (n = t.options.steps.map((e => {
                        if ("string" == typeof e.target) {
                            const i = document.querySelector(e.target);
                            i && (e.target = i, t.options.targetPadding && t.options.autoScrollOffset ? i.style.scrollMargin = t.options.autoScrollOffset + t.options.targetPadding + "px 0" : i.style.scrollMargin = "30px 0")
                        }
                    ...
                    return o && o.forEach((e => {
                        const i = e.getAttribute("data-tg-title"), o = e.getAttribute("data-tg-tour"),
                            r = e.getAttribute("data-tg-group"), s = e.getAttribute("data-tg-order"),
                            a = e.getAttribute("data-tg-fixed"), l = e.getAttribute("data-tg-margin"),
                            c = e.getAttribute("data-tg-dialog-target"), d = e.getAttribute("data-tg-propagate-events");
                    ...
                    })), t.group && (n = n.filter((e => e.group === t.group))), n.forEach(((t, e) => t._index = e)), n.sort((function (t, e) {
                        return t.order == e.order ? (t._index ?? 0) - (e._index ?? 0) : (t.order ?? 0) - (e.order ?? 0)
            ...
            Object.defineProperty(e, "__esModule", {value: !0});
            const o = n(i(755)), r = i(693), s = n(i(570));
            ...
            Object.defineProperty(e, "__esModule", {value: !0}), e.default = async function () {
                return new Promise((async (t, e) => {
                    if (this._promiseWaiting) return e("Promise waiting");
                    if (this._promiseWaiting = !0, this._globalBeforeExitCallback) try {
                        await this._globalBeforeExitCallback()
                    } catch (t) {
                        return e(t)
                    }
                    return this.dialog.style.display = "none", this.backdrop.style.display = "none", this.isVisible = !1, this.options.rememberStep || (this.activeStep = 0), this.options.debug && console.info("Tour exited"), document.body.classList.remove("tg-no-interaction"), await this.destroyListeners(), setTimeout((() => {
                        this._globalAfterExitCallback && this._globalAfterExitCallback()
                    }), 0), this._promiseWaiting = !1, t(!0)
                }))
            }
        }, 283: (t, e) => {
            Object.defineProperty(e, "__esModule", {value: !0}), e.delFinishedTour = e.getIsFinished = void 0, e.getIsFinished = function (t = "tour") {
            ...
            e.default = async function (t) {
                return new Promise((async (e, i) => {
                    ...
                    return await n.visitStep(this.activeStep).catch((t => (this.options.debug && console.warn(t), i(t)))), await (0, o.default)(".tg-dialog").then((async () => {
                        await this.initListeners(), this.options.dialogAnimate && this.dialog.classList.add("animate-position"), this.options.exitOnClickOutside || document.body.classList.add("tg-no-interaction")
                    })), e(!0)
                }))
            }
        }, 483: function (t, e, i) {
            ...
            const o = i(693), r = n(i(830));

            function s(t, e) {
                return new Promise((async (i, n) => {
                    if (e >= t.tourSteps.length) return n("End of tour steps");
                    if (e < 0) return n("Start of tour steps");
                    const s = t.activeStep, a = t.tourSteps[s], l = t.tourSteps[e];
                    if (!l || !a) return n("Step not found by index");
                    if (a.target && a.target.classList.remove("tg-active-element"), (t._globalBeforeChangeCallback && e !== s || a.beforeLeave || l.beforeEnter) && (t._promiseWaiting = !0, t.dialog.classList.add("tg-dialog-loading")), t._globalBeforeChangeCallback && e !== s) try {
                        await t._globalBeforeChangeCallback(s, e)
                    } catch (t) {
                        return n(t)
                    }
                    if (e !== s && a.beforeLeave) try {
            ...
            e.handleVisitNextStep = async function () {
                ...
                return new Promise((async (e, i) => this._promiseWaiting ? i("Promise waiting") : ("string" == typeof t && (t = "next" === t ? this.activeStep + 1 : this.activeStep - 1), t >= this.tourSteps.length ? void await this.finishTour(!0, this.group) : (await s(this, t).catch((t => i(t))), e(!0)))))
            }
        }, 717: (t, e) => {
            Object.defineProperty(e, "__esModule", {value: !0});
            e.default = {
