...
INSTALLED_APPS = [
    ...
    #'debug_toolbar', # bei Produktion entfernen
    'core',
    'home',
    'personals',
    'verbrauch',
...
MIDDLEWARE = [
    #'debug_toolbar.middleware.DebugToolbarMiddleware', # bei Produktion entfernen
...
RECAPTCHA_PRIVATE_KEY = passwords['recaptcha_secret_key']
